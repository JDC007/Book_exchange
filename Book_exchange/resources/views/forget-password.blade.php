        ...
        <div class="row">
          ...
          <div class="col-md-6" "col-md-offset-6" style="background-color:light;">
            <div class="page-login-form box">
              ...
              <h4 style="margin-bottom: 20px;"> No need to worry. Just enter your registered email address and we will send you a link to reset your account password </h4>
              <form role="form" class="login-form">
                <div class="form-group">
                  <div class="input-icon">
                    <i class="icon fa fa-envelope"></i>
                    <input type="email" style="text-align:center" id="sender-email" class="form-control" name="email" placeholder="Email" required>
                  </div>
                </div> 
                
                <button class="btn btn-success" style="background-color:green; margin-bottom: 20px; margin-top: 20px;">Send Me Reset Link</button>
              </form>
              <ul class="form-links"">
                <li class="pull-center"> Don't have an account? </li>
                <li class="pull-center"><a href="signup.php">Register yourself here</a></li>
              </ul>
            </div>
          </div>
        </div>
