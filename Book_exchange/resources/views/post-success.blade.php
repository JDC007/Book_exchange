        ...
        <div class="row">
          ...
          <div class="col-md-6" "col-md-offset-6" style="background-color:light;">
            <div class="page-login-form box">
              ...
              <h4 style="margin-bottom: 20px;"> Your post has been published successfully </h4>
              
                
                <a class="btn btn-success" href="account-myads.php" style="background-color:green; margin-bottom: 20px; margin-top: 20px;">Show My Posts</a>
